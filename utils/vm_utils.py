...
from tools import pchelper#, taskis
...
class VM_Actions(object):
    ...
    def delete_vm(self, vc_name, vc_username, vc_password, vm_name):

        """

        Function to delete a VM from the disk
        ...
        try:
            ...
            if vm.runtime.powerState != vim.VirtualMachinePowerState.poweredOff:
                ...
                print('Powering Off the VM {}'.format(vm_name))
                ...
                print('VM {} is Powered-Off'.format(vm_name))

            if vm.runtime.powerState != vim.VirtualMachinePowerState.poweredOff:

                print('Could not Power-Off the VM, Please check manually...')

                return -1

            task = vm.Destroy()

            print("Successfully deleted the VM")
