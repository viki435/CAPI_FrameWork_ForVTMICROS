...
class VtCode_Test(BaseContent_Test):
    ...
    def test_vtmicros(self):
        ...
        for VM in vms_list:
            ...
            upload_file_to_vm(si,esxi_ip,VM,vm_username,vm_password,"/home/root1/mlc", '/home/reddyr/TestCAPIAutomation/temp_CAPI_Automation/mlc')        
            time.sleep(20)
        ...
        cmd_to_vm_session = './mlc'
        _logger.info("Executing mlc...")
        #execute_program_in_vm(si, vm_name, vm_username, vm_password, "/home/root1/vtmicros", cmd_to_vm_session)  
            
        thread_list = []
        for VM in vms_list:
                output = thread(si, VM, vm_username, vm_password, '/home/root1/mlc', cmd_to_vm_session)
