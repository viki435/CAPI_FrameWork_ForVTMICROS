#Connect-VIServer -Server 10.45.134.133 -Protocol https -User root -Password intel@123
#Connect-VIServer 10.45.134.133 -user root -password intel@123
