...
class VtCode_Test(BaseContent_Test):
    ...
    def setUp(self):
        ...
        self.list_esxi_hosts = [
            ...
            "vms_names":[                    
                    ...
                    #self.yaml_configuration['sut']['esxi']['vms']['vm4']['vm_name'],
                    #self.yaml_configuration['sut']['esxi']['vms']['vm5']['vm_name'],
                    #self.yaml_configuration['sut']['esxi']['vms']['vm6']['vm_name']
                ],
            },           
        ]
    ...
    def test_vtmicros(self):
        ...
        #vm_name_3 = self.yaml_configuration['sut']['esxi']['vms']['vm4']['vm_name']
        #vm_name_4 = self.yaml_configuration['sut']['esxi']['vms']['vm5']['vm_name']
        #vm_name_5 = self.yaml_configuration['sut']['esxi']['vms']['vm6']['vm_name']
        ...
        #print("fourth vm name is ", vm_name_3)
        #print("fifth vm name is ", vm_name_4)
        #print("sixth vm name is ", vm_name_5)
        ...
        #VMs_3 = vm_actions.get_VM_names(vm_name_3, 1, 1)
        #VMs_4 = vm_actions.get_VM_names(vm_name_4, 1, 1)
        #VMs_5 = vm_actions.get_VM_names(vm_name_5, 1, 1)
        ...
        #print(VMs_4)
        #print(VMs_5)
        vms_list=VMs+VMs_1+VMs_2#+VMs_3+VMs_4+VMs_5
