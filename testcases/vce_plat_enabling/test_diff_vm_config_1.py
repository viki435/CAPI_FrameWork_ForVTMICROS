...
class VtCode_Test(BaseContent_Test):
    ...
    def test_vtmicros(self):
        ...
        #os.system("ansible-playbook /home/reddyr/TestCAPIAutomation/temp_CAPI_Automation/testcases/vce_plat_enabling/create_fedora_VMs.yml")
        ...
        vms_list = ['SJ_WithUbuntu_VTMicros_4', 'SJ_WithUbuntu_VTMicros_5']
        ...
        for i in range(0,l,2):
                #for VM in vms_list:
                    ...
                    #p = subprocess.Popen(["powershell.exe","/home/reddyr/TestCAPIAutomation/temp_CAPI_Automation/testcases/vce_plat_enabling/get_vm_deatails.ps1", esxi_ip, esxi_user, esxi_password, vms_list[j], list_value[i], list_value[i+1]], stdout=subprocess.PIPE)
                    cmd = ["powershell.exe", "-ExecutionPolicy", "Unrestricted", "-File", "/home/reddyr/TestCAPIAutomation/temp_CAPI_Automation/testcases/vce_plat_enabling/get_vm_deatails.ps1", esxi_ip, esxi_user, esxi_password, vms_list[j], list_value[i], list_value[i+1]] # Specify relative or absolute path to the script
        ...
        for VM in vms_list:
            ...
            upload_file_to_vm(si,esxi_ip,VM,vm_username,vm_password,"/home/root1/vtmicros", '/home/reddyr/TestCAPIAutomation/temp_CAPI_Automation/vtmicros')        
            time.sleep(20)
            upload_file_to_vm(si,esxi_ip,VM,vm_username,vm_password,"/home/root1/inputFile.config", '/home/reddyr/TestCAPIAutomation/temp_CAPI_Automation/inputFile.config')        
            time.sleep(10)
        ...
        for VM in vms_list:
            download_file_from_vm(si, esxi_ip, VM, vm_username, vm_password, '/home/root1/output.txt', "/home/reddyr/TestCAPIAutomation/temp_CAPI_Automation/output_"+ VM +".txt", port_no=443)
            time.sleep(10)
