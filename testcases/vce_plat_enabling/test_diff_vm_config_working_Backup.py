    ...
    def test_vtmicros(self):
        ...
        for i in range(0,l,2):
                for VM in vms_list:
                    ...
                    p = subprocess.Popen(["powershell.exe","/home/reddyr/TestCAPIAutomation/temp_CAPI_Automation/testcases/vce_plat_enabling/get_vm_deatails.ps1", esxi_ip, esxi_user, esxi_password, vm_name, list_value[i], list_value[i+1]], stdout=subprocess.PIPE)
                    print(p.communicate)
                    #p.wait()
        time.sleep(30);
