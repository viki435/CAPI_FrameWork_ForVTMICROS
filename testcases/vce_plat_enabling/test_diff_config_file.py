...
class VtCode_Test(BaseContent_Test):
    ...
    def test_vtmicros(self):
        ...
        for VM in vms_list:
            ...
            time.sleep(10)
            #TODO - vm_actions.delete_vm(vc_ip,vc_user,vc_password,VM)
            #time.sleep(10)
        ...
        print("*************************************************************************")
        print("Not calling Ansible Script for now")
        print("*************************************************************************")
...
#                    print("Setting the Node Affinity to this in the vmx file: ", data[lineNumNodeAffinity_5])
        ...
        print("Giving 5 minutes delay for just waiting at the end of execution")
        time.sleep(300)#Giving 5 minutes delay for just waiting at the end of execution
