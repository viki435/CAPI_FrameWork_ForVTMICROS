...
class VtCode_Test(BaseContent_Test):
    ...
    def test_vtmicros(self):
        ...
        os.system("ansible-playbook /CAPI_FrameWork_ForVTMICROS/testcases/vce_plat_enabling/create_fedora_VMs.yml")
        ...
        for VM in vms_list:
            ...
            upload_file_to_vm(si,esxi_ip,VM,vm_username,vm_password,"/home/root1/vtmicros", '/CAPI_FrameWork_ForVTMICROS/vtmicros')        
            time.sleep(20)
            upload_file_to_vm(si,esxi_ip,VM,vm_username,vm_password,"/home/root1/inputFile.config", '/CAPI_FrameWork_ForVTMICROS/inputFile.config')        
            time.sleep(10)
        ...
        for VM in vms_list:
            download_file_from_vm(si, esxi_ip, VM, vm_username, vm_password, '/home/root1/output.txt', "/CAPI_FrameWork_ForVTMICROS/output_"+ VM +".txt", port_no=443)
            time.sleep(10)
